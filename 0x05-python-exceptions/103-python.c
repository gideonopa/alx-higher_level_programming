...
/**
 * print_python_list - prints the basic info
 *                   of a python list object
 * @p: python list
 * Return: void
 */
...
/**
* print_python_bytes - prints some basic
...
/**
* print_python_float - prints the value of
 *                float object in python
* @p: object in python
* Return: void
*/
